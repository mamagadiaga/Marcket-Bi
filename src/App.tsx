  ...
  return (
    ...
    <div className="">
      ...
      <div className='p-4 mt-10'>
        <p className='font-bold text-3xl'>Top Produits</p>
        ...
        <div className="hover max-w-sm p-4 shadow-lg bg-white rounded-lg pb-0">
          <a href="#">
            <img className="rounded-lg" src="https://api.market-bi.com/media/slides/bg.webp" alt="" />
          </a>
          <div className="p-5">
            <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2'>
              <div>
                <p className="font-bold text-gray-700">"Sac de marque a 4 pieces"</p>
              </div>
              <div>
                <p className="font-bold text-gray-700">Par: Famcha Hijab store</p>
              </div>
            </div>
            <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2'>
              <div>
              ...
              <div>
                <p className="font-bold text-gray-700">Prix: 15000FCFA</p>
              </div>
            </div>
        ...
        <div className="hover max-w-sm p-4 shadow-lg bg-white rounded-lg pb-0">
          ...
          <div className="p-5">
            <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2'>
              <div>
                <p className="font-bold text-gray-700">"Coffret de parfum"</p>
              </div>
              <div>
                <p className="font-bold text-gray-700">Par: Aicha Diop</p>
              </div>
            </div>
            <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2'>
              <div>
              ...
              <div>
                <p className="font-bold text-gray-700">Prix: 22000FCFA</p>
              </div>
            </div>
        ...
        <div className="hover max-w-sm p-4 shadow-lg bg-white rounded-lg pb-0">
          ...
          <div className="p-5">
            <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2'>
              <div>
                <p className="font-bold text-gray-700">"Mixeur"</p>
              </div>
              <div>
                <p className="font-bold text-gray-700">Par: Madjiguene Diop</p>
              </div>
            </div>
            <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2'>
              <div>
              ...
              <div>
                <p className="font-bold text-gray-700">Prix: 13000FCFA</p>
              </div>
            </div>
        ...
        <div className="hover max-w-sm p-4 shadow-lg bg-white rounded-lg pb-0">
          ...
          <div className="p-5">
            <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2'>
              <div>
                <p className="font-bold text-gray-700">"Fouet"</p>
              </div>
              <div>
                <p className="font-bold text-gray-700">Par: Madjiguene Diop</p>
              </div>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2'>
              ...
              <div>
                <p className="font-bold text-gray-700">Prix: 5000FCFA</p>
              </div>
            </div>
